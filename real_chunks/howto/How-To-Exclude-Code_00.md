### How do I exclude code from being processed by Trick? > Exclude directories via TRICK\_ICG\_EXCLUDE makefile or environment variable: > Exclude files via Trick header comment tag:
